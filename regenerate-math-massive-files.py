...
def generate_part(part_num, start_idx, count):
    ...
    with open(filename, "w", encoding="utf-8") as f:
        f.write("/**\n")
        f.write(f" * Suku AI — Extended Math Training Data Part {part_num}\n")
        ...
        f.write("            return;\n")
        f.write("        }\n\n")
        f.write(f"        console.log('Loading extended math training data part {part_num}...');\n")
        ...
        f.write(f"        console.log(`✅ Extended math training data part {part_num} loaded: ${{added}} entries in ${{elapsed}}ms`);\n")
        f.write("    }\n\n")
