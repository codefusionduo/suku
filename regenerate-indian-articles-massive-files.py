...
def generate_part(part_num, start_idx, count):
    ...
    print(f"Generating Indian Articles Part {part_num} (topics {start_idx} to {start_idx + count - 1}) -> {filename}...")
    
    with open(filename, "w", encoding="utf-8") as f:
        f.write("/**\n")
        f.write(f" * Suku AI — Extended Indian Constitutional Articles Training Data Part {part_num}\n")
        f.write(" * Programmatically generated unique Indian political articles patterns.\n")
        f.write(" */\n\n")
        f.write("(function() {\n")
        f.write("    'use strict';\n\n")
        ...
        f.write("            return;\n")
        f.write("        }\n\n")
        f.write(f"        console.log('Loading extended Indian constitutional articles training data part {part_num}...');\n")
        ...
        f.write(f"        console.log(`✅ Extended Indian constitutional articles training data part {part_num} loaded: ${{added}} entries in ${{elapsed}}ms`);\n")
        f.write("    }\n\n")
