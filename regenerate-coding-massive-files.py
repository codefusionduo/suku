...
def generate_part(part_num, start_idx, count):
    ...
    print(f"Generating Coding Part {part_num} (topics {start_idx} to {start_idx + count - 1}) -> {filename}...")
    
    with open(filename, "w", encoding="utf-8") as f:
        f.write("/**\n")
        f.write(f" * Suku AI — Extended Coding Training Data Part {part_num}\n")
        f.write(" * Programmatically generated unique code snippets across multiple languages.\n")
        f.write(" */\n\n")
        f.write("(function() {\n")
        f.write("    'use strict';\n\n")
        ...
        f.write("            return;\n")
        f.write("        }\n\n")
        f.write(f"        console.log('Loading extended coding training data part {part_num}...');\n")
        ...
        f.write(f"        console.log(`✅ Extended coding training data part {part_num} loaded: ${{added}} entries in ${{elapsed}}ms`);\n")
        f.write("    }\n\n")
